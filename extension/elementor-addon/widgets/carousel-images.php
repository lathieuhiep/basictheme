...
class paint_Elementor_Addon_Carousel_Images extends Widget_Base {
	...
	public function get_name() {
		return 'paint-carousel-images';
	}

	public function get_title() {
		return esc_html__( 'Carousel Images', 'paint' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Carousel Images', 'paint' ),
		...
		$repeater->add_control(
			'list_title', [
				...
				'default' => esc_html__( 'Title #1' , 'paint' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_title' => __( 'Title #1', 'paint' ),
					],
					[
						'list_title' => __( 'Title #2', 'paint' ),
					],
                    [
                        'list_title' => __( 'Title #3', 'paint' ),
                    ],
                    [
                        'list_title' => __( 'Title #4', 'paint' ),
                    ],
				],
