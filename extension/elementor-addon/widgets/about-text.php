...
class paint_Elementor_Addon_About_Text extends Widget_Base {
    ...
    public function get_name() {
        return 'paint-about-text';
    }

    public function get_title() {
        return esc_html__( 'About Text', 'paint' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       =>  esc_html__( 'Heading About Text', 'paint' ),
                'label_block'   =>  true
            ]
        );
        ...
        $this->add_control(
            'align',
            [
                'label'     =>  esc_html__( 'Alignment Title', 'paint' ),
