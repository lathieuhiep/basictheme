...
class paint_Elementor_Addon_Info_Box extends Widget_Base {
	...
	public function get_name(): string {
		return 'paint-info-box';
	}

	public function get_title(): string {
		return esc_html__( 'Info box', 'paint' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'img_type',
			[
				'label' => esc_html__('Infobox Type', 'paint'),
				'type' => Controls_Manager::SELECT,
				'default' => 'img-on-top',
				'label_block' => false,
				'options' => [
					'img-on-top' => esc_html__('Image/Icon On Top', 'paint'),
					'img-on-left' => esc_html__('Image/Icon On Left', 'paint'),
					'img-on-right' => esc_html__('Image/Icon On Right', 'paint'),
				],
			]
		);
		...
		$this->add_control(
			'img_or_icon',
			[
				'label' => esc_html__('Image or Icon', 'paint'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'none' => [
						'title' => esc_html__('None', 'paint'),
						'icon' => 'fa fa-ban',
					],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Position', 'paint'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'condition' => [
					'img_type!' => 'img-on-top',
		...
		$this->add_control(
			'selected_image',
			[
				'label' => esc_html__('Infobox Image', 'paint'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('This is an icon box', 'paint'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'rows' => 10,
				'default' => esc_html__('Write a short description, that will describe the title or something informational and useful.', 'paint'),
		...
		$this->add_control(
			'show_description',
			[
				'label' => esc_html__('Show Description', 'paint'),
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__('Content Alignment', 'paint'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => esc_html__('Icon Size', 'paint'),
		...
		$this->add_control(
			'icon_color',
			[
				'label' => esc_html__('Icon Color', 'paint'),
