...
class BasicTheme_Elementor_Addon_Info_Box extends Widget_Base {
    ...
    ?>
        <#
        view.addRenderAttribute( 'infobox_inner', 'class', 'element-info-box' );

        // add class img type
        if ( settings.img_type === 'img-on-left' ) {
            view.addRenderAttribute( 'infobox_inner', 'class', 'icon-on-left' );
        } else if ( settings.img_type === 'img-on-right' ) {
            view.addRenderAttribute( 'infobox_inner', 'class', 'icon-on-right' );
        } else {
            view.addRenderAttribute( 'infobox_inner', 'class', 'icon-on-top' );
        }

        // render image
        if ( settings.selected_image.url ) {
            var image = {
        ...
        <div {{{ view.getRenderAttributeString( 'infobox_inner' ) }}}>
            <# if ( settings.img_or_icon !== 'none' ) { #>
                <div class="element-info-box__icon">
                    <# if ( settings.img_or_icon === 'img' ) { #>
                        <img src="{{ image_url }}">
                    <# } #>

                    <# if ( settings.img_or_icon === 'icon' ) { #>
                        <div class="icon-box elementor-icon">
                            {{{ iconHTML.value }}}
                        </div>
                    <# } #>
