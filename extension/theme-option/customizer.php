 ...
 * */
new Section(
    'basictheme_opt_section_favicon',
    [
...
new Image(
    [
        ...
        'label' => esc_html__('Upload Favicon Image', 'basictheme'),
        'section' => 'basictheme_opt_section_favicon',
        'default' => '',
    ]
);
...
new Image(
    [
        ...
        'label' => esc_html__('Upload Logo', 'basictheme'),
        'section' => 'basictheme_opt_section_logo',
        'default' => '',
        'choices' => [
            'save_as' => 'id',
        ],
...
new Dimensions(
    [
        ...
        'label' => esc_html__('Set width/heigh', 'basictheme'),
...
new URL(
    [
        'settings' => 'basictheme_opt_url_social_facebook',
        'label' => esc_html__('Facebook', 'basictheme'),
...
new URL(
    [
        'settings' => 'basictheme_opt_url_social_youtube',
        'label' => esc_html__('Youtube', 'basictheme'),
        'section' => 'basictheme_opt_section_social_network',
        'default' => '#',
    ]
);
...
new URL(
    [
        'settings' => 'basictheme_opt_url_social_twitter',
        'label' => esc_html__('Twitter', 'basictheme'),
        'section' => 'basictheme_opt_section_social_network',
        'default' => '#',
    ]
);
...
new URL(
    [
        'settings' => 'basictheme_opt_url_social_instagram',
        'label' => esc_html__('Instagram', 'basictheme'),
        'section' => 'basictheme_opt_section_social_network',
        'default' => '#',
    ]
);
 ...
 * */
new Section(
    'basictheme_opt_section_loading',
    [
        'title' => esc_html__('Loading', 'basictheme'),
        'panel' => 'basictheme_opt_panel',
        'priority' => 10,
    ]
);
...
new Radio_Buttonset(
    [
        ...
        'section' => 'basictheme_opt_section_loading',
        'default' => 'off',
        'choices' => [
 ...
 * */
new Section(
    'basictheme_opt_section_back_to_top',
    [
        'title' => esc_html__('Back To Top', 'basictheme'),
        'panel' => 'basictheme_opt_panel',
        'priority' => 10,
    ]
);
...
new Radio_Buttonset(
    [
        ...
        'section' => 'basictheme_opt_section_back_to_top',
        'default' => 'on',
        'choices' => [
            'on' => esc_html__('Show', 'basictheme'),
            'off' => esc_html__('Hide', 'basictheme'),
