<div class="tabs-warp">
	<ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
		<li class="nav-item" role="presentation">
			<button class="nav-link active" id="color-code-tab" data-bs-toggle="pill" data-bs-target="#color-code" type="button" role="tab" aria-controls="color-code" aria-selected="true">
		...
		<li class="nav-item" role="presentation">
			<button class="nav-link" id="product-info-tab" data-bs-toggle="pill" data-bs-target="#product-info" type="button" role="tab" aria-controls="product-info" aria-selected="false">
