               ...
               ?>
                   <div class="entry-post__box">
                       <div class="entry-image">
                           <div class="slider-for custom-slick-carousel" data-config-slick='<?php echo wp_json_encode( $config_slider_for ); ?>'>
                           ...
                           <div class="slider-nav custom-slick-carousel" data-config-slick='<?php echo wp_json_encode( $config_slider_nav ); ?>'>
                               <div class="image-tool">
                       ...
                       <div class="entry-content">
                           ...
                           <div class="info">
                               <div class="info__top">
                                   ...
                                   <div class="right-box">
                                       <a class="icon-image" href="<?php echo esc_url( $url ); ?>" target="_blank">
