...
<div class="content-warp faq-warp element-spacer">
    <div class="container">
	        ...
	        <?php $i = 1; while ( $query->have_posts() ): $query->the_post(); ?>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="post-<?php the_ID(); ?>">
                        <button class="accordion-button<?php echo esc_attr( $i !== 1 ? ' collapsed' : '' ); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#panels-post-<?php the_ID(); ?>" aria-expanded="true" aria-controls="panels-post-<?php the_ID(); ?>">
                            <?php the_title(); ?>
                        </button>
                    </h2>

                    <div id="panels-post-<?php the_ID(); ?>" class="accordion-collapse collapse<?php echo esc_attr( $i == 1 ? ' show' : '' ); ?>" aria-labelledby="post-<?php the_ID(); ?>">
